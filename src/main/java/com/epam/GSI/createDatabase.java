    ...
    public static void creation() {
        ...
        try {
            ...
            sqlArray1[0] = "CREATE TABLE USERS(ID INT PRIMARY KEY AUTO_INCREMENT, FIRST_NAME VARCHAR(255)," +
                    " SECOND_NAME VARCHAR(255), LAST_NAME VARCHAR(255), AGE INT, NUMBER VARCHAR(255))";
            logArray1[1] = "Creating table CURRENCY";
            sqlArray1[1] = "CREATE TABLE CURRENCY(ID INT PRIMARY KEY AUTO_INCREMENT," +
                    " NAME VARCHAR(255), COURSE_BUY NUMERIC(7,3), COURSE_SELL NUMERIC(7,3))";
            ...
            sqlArray1[5] = "CREATE VIEW ACC_VIEW AS SELECT ACCOUNT.ID, USERS.LAST_NAME, USERS.FIRST_NAME," +
                    " USERS.SECOND_NAME, USERS.AGE, USERS.NUMBER, MONEY, LOAN, CURRENCY.NAME ,CURRENCY.COURSE_BUY," +
                    " CURRENCY.COURSE_SELL, (ACCOUNT.MONEY * CURRENCY.COURSE_BUY) AS SUM_UAH FROM ACCOUNT JOIN CURRENCY" +
                    " ON ACCOUNT.CRID = CURRENCY.ID JOIN USERS ON ACCOUNT.USID = USERS.ID ";
            logArray1[6] = "Disable foreign key check.";
            ...
            sqlArray3[0] = "CREATE TABLE OPERATIONS (ID INT PRIMARY KEY AUTO_INCREMENT, ACID_FROM INT," +
                    ...
                    " CURRENCY_NAME VARCHAR(255), CURRENCY_COURSE_BUY NUMERIC(7,3), CURRENCY_COURSE_SELL NUMERIC(7,3)," +
                    " CRID INT, OPERATION_TIME DATETIME)";
            ...
            sqlArray2[0] = "INSERT INTO CURRENCY (ID, NAME, COURSE_BUY, COURSE_SELL) VALUES ('1', 'UAH', '1', '1')";
            ...
            sqlArray2[4] = "INSERT INTO CURRENCY (ID, NAME, COURSE_BUY, COURSE_SELL) VALUES ('2', 'USD', '27', '27.2')";
            logArray2[5] = "Adding new currency.";
            sqlArray2[5] = "INSERT INTO CURRENCY (ID, NAME, COURSE_BUY, COURSE_SELL) VALUES ('3', 'EURO', '30', '30.2')";
            logArray2[6] = "Adding new currency.";
            sqlArray2[6] = "INSERT INTO CURRENCY (ID, NAME, COURSE_BUY, COURSE_SELL) VALUES ('4', 'RUB', '0.40', '0.45')";
            logArray2[7] = "Adding new currency.";
            sqlArray2[7] = "INSERT INTO CURRENCY (ID, NAME, COURSE_BUY, COURSE_SELL) VALUES ('5', 'PLZ', '4', '4.2')";
            logArray2[8] = "Adding new currency.";
            sqlArray2[8] = "INSERT INTO CURRENCY (ID, NAME, COURSE_BUY, COURSE_SELL) VALUES ('6', 'GBP', '32', '32.2')";
